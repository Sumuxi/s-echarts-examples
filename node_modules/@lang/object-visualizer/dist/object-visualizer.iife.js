var ObjectVisualizer = (function (exports) {
    'use strict';
    ...
    var script = {
      ...
      props: {
        path: {
          ...
          validator(path) {
            return (
              objectToString$1(path) === "Array" &&
              path.every(
                (key) =>
                  objectToString$1(key) === "String" ||
                  objectToString$1(key) === "Number"
              )
            );
          },
        },
    ...
    const _hoisted_2 = /*#__PURE__*/createVNode("span", { class: "value" }, "null", -1 /* HOISTED */);
    ...
    function render$1(_ctx, _cache, $props, $setup, $data, $options) {
      return (openBlock(), createBlock("span", {
        ...
        createVNode("span", {
          class: "key",
          innerHTML: $props.renderName($props.name, $props.path)
        }, null, 8 /* PROPS */, ["innerHTML"]),
        ($props.name !== '')
          ? (openBlock(), createBlock("span", _hoisted_1, ": "))
          : createCommentVNode("v-if", true),
        _hoisted_2
      ], 8 /* PROPS */, ["aria-level", "id"]))
    }
    ...
    var script$1 = {
      ...
      props: {
        ...
        data: {
          required: true,
          validator(data) {
            return objectToString$1(data) === "Boolean";
          },
        },
        name: {
          required: true,
    ...
    function render$2(_ctx, _cache, $props, $setup, $data, $options) {
      return (openBlock(), createBlock("span", {
        ...
        ($props.name !== '')
          ...
          : createCommentVNode("v-if", true),
        createVNode("span", _hoisted_2$1, toDisplayString($props.data), 1 /* TEXT */)
      ], 8 /* PROPS */, ["aria-level", "id"]))
    }
    ...
    const _hoisted_2$2 = { class: "value" };
    ...
    function render$3(_ctx, _cache, $props, $setup, $data, $options) {
      return (openBlock(), createBlock("span", {
        ...
        ($props.name !== '')
          ? (openBlock(), createBlock("span", _hoisted_1$2, ": "))
          : createCommentVNode("v-if", true),
        createVNode("span", _hoisted_2$2, toDisplayString($props.data), 1 /* TEXT */)
      ], 8 /* PROPS */, ["aria-level", "id"]))
    }
    ...
    var script$3 = {
      ...
      props: {
        ...
        data: {
          required: true,
          validator(data) {
            return objectToString$1(data) === "String";
          },
        },
        name: {
          required: true,
    ...
    const _hoisted_2$3 = /*#__PURE__*/createVNode("span", { class: "quotes" }, "\"", -1 /* HOISTED */);
    const _hoisted_3 = { class: "value" };
    const _hoisted_4 = /*#__PURE__*/createVNode("span", { class: "quotes" }, "\"", -1 /* HOISTED */);
    ...
    function render$4(_ctx, _cache, $props, $setup, $data, $options) {
      return (openBlock(), createBlock("span", {
        ...
        ($props.name !== '')
          ...
          : createCommentVNode("v-if", true),
        _hoisted_2$3,
        createVNode("span", _hoisted_3, toDisplayString($props.data), 1 /* TEXT */),
        _hoisted_4
      ], 8 /* PROPS */, ["aria-level", "id"]))
    }
    ...
    var script$4 = {
      ...
      props: {
        ...
        data: {
          required: true,
          validator(data) {
            return objectToString$1(data) === "Array";
          },
        },
        name: {
          required: true,
    ...
    function render$5(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return (openBlock(), createBlock("span", {
        class: "array",
        role: $props.role,
        "aria-expanded": $setup.isExpanding,
        "aria-level": $props.ariaLevel,
        id: $props.id
      }, [
        createVNode("span", {
        ...
        }, toDisplayString($setup.isExpanding ? "\u25BC" : "\u25B6"), 1 /* TEXT */),
        createVNode("span", {
          class: "key",
        ...
        createVNode("span", {
          class: "separator",
          onClick: _cache[3] || (_cache[3] = (...args) => ($setup.handleClick && $setup.handleClick(...args)))
        }, toDisplayString($props.name === "" ? "" : ": "), 1 /* TEXT */),
        createVNode("span", {
          class: "count",
          onClick: _cache[4] || (_cache[4] = (...args) => ($setup.handleClick && $setup.handleClick(...args)))
        }, toDisplayString($setup.isExpanding === false && $props.data.length >= 2 ? "(" + $props.data.length + ")" : ""), 1 /* TEXT */),
        createVNode("span", {
          class: "preview",
          onClick: _cache[5] || (_cache[5] = (...args) => ($setup.handleClick && $setup.handleClick(...args)))
        }, toDisplayString($setup.isExpanding ? "Array(" + $props.data.length + ")" : "[...]"), 1 /* TEXT */),
        ($setup.isCircular)
                ...
                ? (openBlock(), createBlock("span", _hoisted_1$4, [
                    (openBlock(true), createBlock(Fragment, null, renderList($setup.keys, (key) => {
                      return (openBlock(), createBlock(_component_wrapper, {
                        ...
                        "object-visualizer-uid": $props.objectVisualizerUid,
                        "aria-level": $props.ariaLevel
                      }, null, 8 /* PROPS */, ["name", "path", "data", "expand-signal", "collapse-signal", "expandOnCreatedAndUpdated", "renderName", "getKeys", "object-visualizer-uid", "aria-level"]))
                    }), 128 /* KEYED_FRAGMENT */))
                  ]))
                : createCommentVNode("v-if", true)
            ], 64 /* STABLE_FRAGMENT */))
                ...
                ? (openBlock(), createBlock("span", _hoisted_2$4, [
                    (openBlock(true), createBlock(Fragment, null, renderList($setup.keys, (key) => {
                      return (openBlock(), createBlock(_component_wrapper, {
                        ...
                        "expand-signal": $setup.innerExpandSignal,
                        "collapse-signal": $setup.innerCollapseSignal,
                        expandOnCreatedAndUpdated: $props.expandOnCreatedAndUpdated,
                        getKeys: $props.getKeys,
                        renderName: $props.renderName,
                        "object-visualizer-uid": $props.objectVisualizerUid,
                        "aria-level": $props.ariaLevel
                      }, null, 8 /* PROPS */, ["name", "path", "data", "expand-signal", "collapse-signal", "expandOnCreatedAndUpdated", "getKeys", "renderName", "object-visualizer-uid", "aria-level"]))
                    }), 128 /* KEYED_FRAGMENT */))
                  ]))
                : createCommentVNode("v-if", true)
            ], 64 /* STABLE_FRAGMENT */))
      ], 8 /* PROPS */, ["role", "aria-expanded", "aria-level", "id"]))
    }
    ...
    var script$5 = {
      ...
      props: {
        ...
        data: {
          required: true,
          validator(data) {
            return objectToString$1(data) === "Object";
          },
        },
        name: {
          required: true,
    ...
    function render$6(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return (openBlock(), createBlock("span", {
        ...
        ($setup.isCircular)
          ...
          : withDirectives((openBlock(), createBlock("span", _hoisted_2$5, [
              (openBlock(true), createBlock(Fragment, null, renderList($setup.keys, (key) => {
                return (openBlock(), createBlock(_component_wrapper, {
                  key: key,
                  class: "value",
    ...
    const Wrapper = {
      ...
      props: {
        ...
        data: {
          ...
          validator(data) {
            return (
              objectToString$1(data) === "Null" ||
              objectToString$1(data) === "Boolean" ||
              objectToString$1(data) === "Number" ||
              objectToString$1(data) === "String" ||
              objectToString$1(data) === "Array" ||
              objectToString$1(data) === "Object"
            );
          },
        },
        name: {
    ...
    function render$7(_ctx, _cache, $props, $setup, $data, $options) {
      return (openBlock(), createBlock(resolveDynamicComponent(_ctx.TYPE_TO_COMPONENT[_ctx.objectToString(_ctx.data)]), {
        name: _ctx.name,
        path: _ctx.path,
        data: _ctx.data,
        ...
        renderName: _ctx.renderName,
        "object-visualizer-uid": _ctx.objectVisualizerUid,
        id: `object-visualizer-${_ctx.objectVisualizerUid}--${
      _ctx.path.length === 0 ? 'root' : _ctx.path.join('-')
    }`,
        role: _ctx.role,
        "aria-level": _ctx.ariaLevel + 1
      }, null, 8 /* PROPS */, ["name", "path", "data", "collapse-signal", "expand-signal", "expandOnCreatedAndUpdated", "getKeys", "renderName", "object-visualizer-uid", "id", "role", "aria-level"]))
    }
    ...
    var mount = (data, el, options = {}) => {
      ...
      if (options.renderName === undefined) options.renderName = defaultConfig.renderName;
